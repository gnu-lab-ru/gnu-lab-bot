...
- test: add comprehensive tests for command parsing and eval linter
- test: enhance eval-linter tests with depth, size, and callee checks
### Docs
- docs: update license information from GPL-3.0-or-later to GPL-2.1(-or-later)
- docs: update protocol and testing specifications with linting details
